...
export const Newsletter = ({ onWhatsAppClick }: NewsletterProps) => {
            ...
            <div className="text-white">
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <div className="flex justify-center lg:justify-start space-x-6 sm:space-x-8">
                  <button onClick={onWhatsAppClick} className="flex flex-col items-center text-[#d68e08] hover:text-[#b8780a] transition-colors cursor-pointer">
