...
<head>
  ...
  <!-- Link para a versão interativa (SPA) -->
  <link rel="alternate" href="${baseUrl}/catalogo/${region.id}" title="Versão interativa">
...
<body>
  ...
  <!-- Aviso para usuários com JS habilitado -->
  <script>
    // Se usuário tem JS, mostra link para versão completa
    document.body.insertAdjacentHTML('afterbegin', 
      '<div style="background:#d68e08;color:white;padding:15px;text-align:center;">' +
      '<strong>Versão simplificada para buscadores.</strong> ' +
      '<a href="${baseUrl}/catalogo/${region.id}" style="color:white;text-decoration:underline;">Clique aqui para ver a versão completa com todos os imóveis</a>' +
      '</div>'
    );
  </script>
</body>
