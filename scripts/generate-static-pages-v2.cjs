...
<body>
  ...
  <!-- Progressive Enhancement: Banner para usuários com JS -->
  <script>
    (function() {
      var banner = document.createElement('div');
      banner.style.cssText = 'background:#d68e08;color:white;padding:12px 20px;text-align:center;position:fixed;top:0;left:0;right:0;z-index:9999;font-size:14px;';
      banner.innerHTML = '<strong>Versão simplificada.</strong> <a href="${BASE_URL}/catalogo/${slug}" style="color:white;text-decoration:underline;margin-left:10px;">Ver versão completa com filtros e todos os imóveis →</a>';
