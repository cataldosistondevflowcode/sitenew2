-- Script para adicionar as colunas necessárias na tabela unified_schedules
...
ALTER TABLE public.unified_schedules 
ADD COLUMN IF NOT EXISTS whatsapp_pdf_url text NULL;
...
WHERE table_name = 'unified_schedules' 
