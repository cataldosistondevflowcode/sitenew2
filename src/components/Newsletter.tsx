        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-lg mb-8">Oportunidades de negócios, dicas sobre leilões, artigos e casos etc</p>
              ...
              <div className="mt-12">
                ...
                <p className="text-lg mb-6 text-[#d68e08]">Entre em contato conosco</p>
