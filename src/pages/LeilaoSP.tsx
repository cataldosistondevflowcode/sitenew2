...
const bairrosPorZonaSP: Record<string, string[]> = {
  'CENTRAL': [
    ...
    'José Bonifácio', 'Liberdade', 'Luz', 'LARGO DA MISERICÓRDIA', 'Mercado', 'Pacaembú', 'PACAEMBU', 'Paraíso',
    'Parque Dom Pedro I', 'Pari', 'Ponte Pequena', 'República',
    'Santa Cecília', 'Santa Ifigênia', 'Sé', 'Sé Bela Vista', 'Vila Bela Vista', 'VILA BELA VISTA',
    'Vila Buarque', 'VILA INGLESA', 'Vila São José', 'VILA SÃO JOSÉ'
  ],
  'LESTE': [
    '3º Sub Penha Franca', 'Alto Da Mooca', 'Anália Franco', 'Aricanduva', 'ÁGUA MARINHA', 'Água Rasa',
    'Austral', 'AUSTRAL', 'Bairro Dos Pereiras', 'Bairro dos Pereiras', 'Belém', 'Cangaiba', 'Catumbi',
    'Carrão', 'Carrãozinho', 'Castro Alves', 'Chacara California', 'CHACARA CALIFORNIA',
    ...
    'Engenheiro Goulart', 'Ermelino Matarazzo', 'Fazenda Aricanduva', 'FAZENDA ARICANDUVA',
    'Guaianases', 'Iguatemi', 'Iguaçu', 'Itaim Paulista', 'Itaquera', 'Jadim Helian', 'JADIM HELIAN',
    'Jardim', 'Jardim Alto Alegre', 'JARDIM ALTO ALEGRE', 'Jardim Alto Alegre (São Rafael)', 'JARDIM ALTO ALEGRE (SÃO RAFAEL)',
    'Jardim América Da Penha', 'Jardim Anália Franco', 'Jardim Aricanduva', 'JARDIM ARICANDUVA', 'JARDIM ARPOADOR', 'JARDIM AURORA',
    'Jardim Cibele', 'Jardim Claudia', 'JARDIM CLAUDIA', 'Jardim Colorado', 'Jardim Da Casa Pintada', 'Jardim da Casa Pintada',
    'Jardim Danfer', 'JARDIM DAS OLIVEIRAS', 'JARDIM DO DIVINO', 'Jardim Gianeti',
    'Jardim Helena', 'JARDIM INDEPENDÊNCIA', 'Jardim Iva', 'JARDIM JUAZEIRO', 'JARDIM LAJEADO',
    'Jardim Marabá', 'Jardim Melunas', 'JARDIM NÉLIA', 'JARDIM NOSSA SENHORA DO CARMO', 'JARDIM NOVE DE JULHO',
    'Jardim Robru', 'JARDIM ROMANO', 'JARDIM SANTA TEREZINHA', 'JARDIM SANTO ANTÔNIO', 'Jardim Textil', 'JARDIM TIETÊ',
    'JARDIM VERÔNIA', 'Jardim Verônia', 'Lajeado', 'Mooca', 'Mooca Baixa', 'Mooca Água Rasa',
    'PARADA XV DE NOVEMBRO', 'PARQUE BOTURUSSU', 'Parque da Mooca', 'PARQUE MOOCA', 'Parque Moóca',
    'PARQUE GUARANI', 'PARQUE PAULISTANO', 'Parque São Jorge', 'PARQUE SÃO LOURENÇO', 'Parque São Lucas', 'PARQUE SÃO RAFAEL',
    'PARQUE SAVOI CITY', 'Passagem Funda', 'PATRIARCA', 'Penha', 'PENHA FRANÇA', 'Penha de França', 'Ponte Rasa',
    'Quarta Parada', 'Sapopemba', 'São Lucas', 'São Mateus', 'SÃO MATHEUS', 'São Miguel Paulista', 'São Rafael',
    'SÍTIO DA FIGUEIRA', 'Tatuapé', 'Usp Leste', 'Vila Alpina', 'VILA ALTO PEDROSO', 'VILA ANTONIETA',
    'VILA ARAGUAIA', 'Vila Aricanduva', 'Vila Bela', 'VILA BELA', 'VILA CARMOSINA', 'Vila Carolina', 'Vila Celeste',
    'VILA CHABILÂNDIA', 'Vila Conceição', 'VILA CONSTANÇA', 'VILA COSMOPOLITA', 'Vila Curuça', 'VILA CURUÇA',
    'Vila Dalila', 'VILA DO ENCONTRO', 'Vila Formosa', 'VILA GUARANI', 'VILA INDEPENDÊNCIA', 'VILA ITAIM',
    'Vila Jacui', 'VILA JACUÍ', 'VILA JUREMA', 'VILA LIBANESA', 'VILA LOURDES', 'Vila Matilde',
    'VILA MESQUITA', 'VILA MONTE SANTO', 'Vila Nhocunhé', 'VILA NHOCUNÉ', 'VILA NORMA',
    'Vila Nova Curuça', 'VILA NOVA CURUÇA', 'VILA NOVA MANCHESTER', 'Vila Nova Savoia', 'VILA NOVA SAVOIA',
    'Vila Paranaguá', 'VILA PLANA', 'VILA PROGRESSO', 'Vila Prudente', 'Vila Ré', 'VILA RÉ',
    'VILA REGENTE FEIJÓ', 'VILA ROSARIA', 'VILA SANTA CLARA', 'VILA SANTA CRUZ', 'Vila Santa Isabel',
    'VILA SANTANA', 'VILA SÃO SILVESTRE', 'Vila Silva Teles', 'VILA SÍLVIA', 'Vila Talarico',
    'VILA TOLSTÓI', 'Vila Tolstói', 'VILA ZÉFIRA', 'Vila Zéfira', 'VILA ZÉPHYR', 'Vila Zéphyr'
  ],
  'NORTE': [
    '36ª Subd Vila Maria', 'Alto De Santana', 'Alto de Santana', 'América', 'Anhanguera',
    'Anhembi', 'Barro Branco', 'Brasilândia', 'Cachoeirinha', 'Cantareira', 'Carandiru',
    'Casa Verde', 'CHORA MENINO', 'CITY AMÉRICA', 'Corisco', 'Freguesia do Ó', 'Furnas',
    'Guapira', 'Horto Florestal', 'Itaberaba', 'Jardim', 'Jardim Anhanguera', 'Jardim Britania',
    'Jardim Dayse', 'JARDIM FRANÇA', 'JARDIM GUAPIRA', 'Jardim Japão', 'JARDIM JARAGUÁ',
    'JARDIM KIOTO', 'Jardim Paraíso', 'JARDIM PARAÍSO', 'Jardim Peri Peri', 'JARDIM RECANTO VERDE',
    'Jardim São Bento', 'Jardim Tremembé', 'Jardim Vista Alegre', 'Jaçanã',
    'Lausane Paulista', 'Lauzane', 'LAUZANE PAULISTA', 'Limão', 'LOTEAMENTO CITY JARAGUÁ',
    'Loteamento Vista Verde', 'LOTEAMENTO VISTA VERDE', 'Mandaqui', 'Morro Grande',
    'PARQUE ANHEMBI', 'Parque Mandaqui', 'PARQUE MANDAQUI', 'Parque Peruche', 'Parque Vitória',
    'PEDRA BRANCA', 'Perus', 'Piqueri', 'Pirituba', 'Santana', 'SANTA TEREZINHA', 'São Domingos',
    'Sítio Do Mandaqui', 'Sítio Mandaqui', 'Tucuruvi', 'VILA ALBERTINA', 'VILA AURORA', 'Vila Cachoeira',
    'Vila Clarice', 'VILA CONSTANÇA', 'Vila Constança', 'VILA DOM PEDRO II', 'VILA EDE', 'Vila Edi',
    'Vila Guilherme', 'Vila Gustavo', 'VILA JOÃO BATISTA', 'Vila Mafra', 'Vila Mangalot',
    'Vila Maria', 'Vila Maria Alta', 'Vila Maria Baixa', 'VILA MAZZEI', 'Vila Medeiros',
    ...
    'Vila Santana', 'VILA SANTOS', 'Vila Siqueira', 'VILA SIQUEIRA', 'Vila Zatt', 'Vista Alegre'
  ],
  'OESTE': [
    '13º Distrito Butantã', 'Alto De Pinheiros', 'Butantã',
    'Caxingui', 'Ceasa', 'Cerqueira Cesar', 'Chacara Maria Trindade', 'CHACARA MARIA TRINDADE',
    'Educandário', 'FAZENDA MORUMBI', 'Ferreira', 'Itaim Bibi', 'Jardim Bonfiglioli',
    'JARDIM COLOMBO', 'Jardim D´Abril', 'JARDIM DAS VERTENTES', 'JARDIM ESMERALDA',
    'JARDIM ESTER YOLANDA', 'JARDIM GILDA MARIA', 'Jardim Iris', 'JARDIM IRIS', 'JARDIM LEOPOLDINA',
    'Jardim Leonor', 'JARDIM LONDRINA', 'JARDIM PARQUE MORUMBI', 'JARDIM SANTO ELIAS',
    'JARDIM SARAH', 'Jardim Vera Cruz', 'JARDIM VITÓRIA RÉGIA',
    'Lapa', 'Lapa De Baixo', 'Lapa de Baixo', 'PAINEIRAS DO MORUMBI', 'PARQUE ANHANGUERA',
    'Parque Cisper', 'PARQUE CISPER', 'Parque Continental', 'PARQUE DA LAPA', 'Parque Da Lapa',
    'PARQUE DAS FLORES', 'Parque Das Flores', 'PARQUE NAÇÕES UNIDAS', 'Paulista', 'Perdizes',
    'Pinheiros', 'Pompeia', 'Raposo Tavares', 'Real Parque', 'Subdistrito Butantã', 'Sumaré',
    'Vila Anastácia', 'VILA BRASILINA', 'VILA BUENOS AIRES', 'VILA GUEDES', 'Vila Hamburguesa',
    'Vila Jaguara', 'Vila Lajeado', 'VILA LAJEADO', 'Vila Leopoldina', 'Vila Madalena',
    'VILA MORSE', 'VILA PIAUÍ', 'Vila Pinheiros', 'Vila Pirajussara', 'Vila Pompeia',
    'Vila Remédios', 'Vila Romana', 'VILA SUZANA'
  ],
  'SUL': [
    'Alto Da Boa Vista', 'Alto da Boa Vista', 'Barragem', 'BELA MARAJOARA', 'Boi Mirim', 'M',
    'Brooklin', 'Brooklin Paulista', 'Campo Grande', 'Campo Limpo',
    'Capela', 'Capela Do Socorro', 'Capão Redondo', 'Centro Empresarial',
    'Chacara Inglesa', 'CHACARA INGLESA', 'Chacara Klabin', 'CHACARA KLABIN',
    'Chacara Santa Maria', 'CHACARA SANTA MARIA', 'Chacara São João', 'CHACARA SÃO JOÃO',
    'Chácara Flora', 'Cidade Dutra', 'Embura', 'Engenho Velho', 'Estância Mirim', 'ESTÂNCIA MIRIM',
    'Grajaú', 'Guarapiranga', 'Hileópolis', 'Iberapuera', 'IBERAPUERA', 'Ibirapuera', 'Interlagos',
    'Ipiranga', 'Jabaquara', 'Jardim Amália', 'JARDIM ANA ROSA', 'Jardim Ângela',
    'JARDIM CARAVELAS', 'JARDIM CELESTE', 'JARDIM DOS LAGOS', 'Jardim Edda', 'Jardim Edi',
    'Jardim Glória', 'JARDIM HELGA', 'Jardim Ingá', 'JARDIM INGÁ', 'JARDIM ITAPURA',
    'JARDIM LEME', 'JARDIM LEONIDAS MOREIRA', 'JARDIM MACEDÔNIA', 'JARDIM MARIA DUARTE',
    'JARDIM MARIA ESTELA', 'JARDIM MIRANTE', 'Jardim Monte Azul', 'JARDIM MONTE AZUL',
    'JARDIM PALMARES', 'JARDIM PATENTE', 'JARDIM ROSCHEL', 'JARDIM SANTA CRUZ',
    'Jardim Santo Amaro', 'Jardim São Luis', 'Jardim Sonia Ingá', 'JARDIM SONIA INGÁ',
    'JARDIM THOMAS', 'JARDIM UMARIZAL', 'JARDIM VERGUEIRO', 'Jardins',
    "M'Boi Mirim", 'Marsilac', 'Moema', 'MOINHO VELHO', 'Vila Moinho Velho', 'VILA MOINHO VELHO',
    'Morumbi', 'NOVA ALEXANDRIA', 'Parelheiros', 'PARQUE ARARIBA', 'Parque Cocaia',
    'PARQUE ESMERALDA', 'PARQUE FONGARO', 'Parque Grajaú', 'Parque Independência', 'PARQUE REBOUÇAS',
    'Piraporinha', 'Planalto Paulista', 'Sacomã', 'Saúde', 'Santo Amaro', 'Socorro',
    'São Francisco', 'São João', 'São João Clímaco', 'Valo Velho', 'VARGEM GRANDE', 'Veleiros',
    'Vila Carioca', 'VILA DA SAÚDE', 'Vila Das Mercês', 'Vila das Mercês', 'VILA FIRMIANO PINTO',
    'Vila Guaraní', 'VILA GUMERCINDO', 'VILA ISA', 'Vila Joaniza', 'VILA LÚCIA',
    'Vila Mariana', 'Vila Mercês', 'VILA MORUMBI', 'VILA NATÁLIA', 'Vila Olímpia',
    'Vila Parque Jabaquara', 'VILA PREL', 'VILA SANTA CATARINA', 'VILA SOFIA', 'Vila Sta Catarina',
    'VILA VERA'
  ]
};
